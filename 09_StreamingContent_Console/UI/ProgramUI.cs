...
namespace _09_StreamingContent_Console.UI
{
    public class ProgramUI
    {
        ...
        // a class-wide field - gives us the same access to the repository
        private readonly StreamingRepository _streamingRepo = new StreamingRepository();

        // constructor to specify which console to use (the real one or the mock one)
        ...
        private void SeedContentList()
        {
            ...
            StreamingContent movieThree = new StreamingContent("Toy Story", "A bromance", MaturityRating.G, 5, GenreType.Comedy);
